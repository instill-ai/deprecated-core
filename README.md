...
Before running `make all` or `make latest`, replace every occurrence of the following in the Dockerfile:

- Replace `https://github.com/instill-ai/vdp.git` with `https://github.com/instill-ai/deprecated-vdp.git`
- Replace `https://github.com/instill-ai/model.git` with `https://github.com/instill-ai/deprecated-model.git`
