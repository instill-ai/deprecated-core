...
🗿 **Instill Core** is the umbrella project consisting of foundation services for [**Instill VDP**](https://github.com/instill-ai/vdp) and [**Instill Model**](https://github.com/instill-ai/model), where essential services such as the [console](https://github.com/instill-ai/console), [user management servers](https://github.com/instill-ai/mgmt-backend), databases, and third-party observability tools find their home here. In addition, **Instill Core** plays a pivotal role in facilitating the seamless launch of both **Instill VDP** and **Instill Model**.
